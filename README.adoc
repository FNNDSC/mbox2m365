...
(Clearly the above relies on ``entr``. Consult your distro's repos for the appropriate install. In arch, this is ``yay -S entr``, in Ubuntu, this is ``sudo apt install entr``)
